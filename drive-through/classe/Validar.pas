...
type
  ...
  public
    ...
    function getRateioValorDesconto(TotalNota, ValorTotalItem, ValorTotalRateio: extended): extended;
...
var
  ...
  Cont     : Byte;
begin
  //if (VarType(sString) <> VarString) and (VarType(sString) <> VarEmpty) then
  //    sString := '';
...
function TValidar.getRateioValorDesconto(TotalNota, ValorTotalItem,
  ValorTotalRateio: extended): extended;
var
  Percentual     : extended;
  RateioUnitario : extended;
  ValorRateioItem: extended;
begin
  Percentual      := ((ValorTotalItem  / TotalNota) * 100);
  ValorRateioItem := ((ValorTotalRateio * Percentual) / 100);
  RateioUnitario  := ValorRateioItem;

  Result := Arredondar(RateioUnitario, 2);
end;
