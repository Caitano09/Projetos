...
type
  Tcontrols = class (Tform)
    ...
    class procedure criacaoFormImpressao2(dataInicio, dataFim: TDate);
...
begin
  ...
  //Verifica se o id não está sendo usado
  Tdados.verificaExclusão( objTipoProduto.id );
...
//Criação do form de Impressão 2
class procedure Tcontrols.criacaoFormImpressao2(dataInicio: TDate; dataFim: TDate);
begin
  Tdados.sqlImpressao(dataInicio, dataFim);
